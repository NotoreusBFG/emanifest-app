...
function LoginPageInner() {
  ...
  // Only ever set by the transporter invite flow's own redirect
  // (register-transporter/[token]/with-account -> /login?accountType=transporter),
  // never a user-facing choice -- transporter accounts are only ever
